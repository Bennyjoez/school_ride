  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { label: 'Scheduled', value: scheduled, color: 'text-blue-600',  bg: 'bg-blue-50',  border: 'border-blue-100'  },
          { label: 'Active',    value: active,    color: 'text-green-600', bg: 'bg-green-50', border: 'border-green-100' },
          { label: 'Completed', value: completed, color: 'text-gray-600',  bg: 'bg-gray-50',  border: 'border-gray-200'  },
        ].map(({ label, value, color, bg, border }) => (
          <div key={label} className={`${bg} rounded-xl border ${border} px-5 py-4`}>
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="relative flex-1 min-w-48">
          ...
          <input type="text" placeholder="Search by route, driver, or plate..."
