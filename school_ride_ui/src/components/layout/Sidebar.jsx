...
const ROLE_LABELS = {
  ...
  '2': { label: 'Director', color: 'blue'   },
  '3': { label: 'Manager',  color: 'blue'   },
  '4': { label: 'Teacher',  color: 'green'  },
  '5': { label: 'Driver',   color: 'amber'  },
  '6': { label: 'Guardian', color: 'green'  },
}
    ...
    <aside className="w-56 shrink-0 h-screen sticky top-0 bg-white border-r border-gray-100 flex flex-col">
      ...
      <div className="px-5 py-5 border-b border-gray-100">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-gray-900 text-sm">SchoolFleet</span>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-gray-100">
        <div className="px-3 py-2 mb-1">
          ...
          <Badge variant={roleInfo.color} className="mt-1">{roleInfo.label}</Badge>
        </div>
        <button
